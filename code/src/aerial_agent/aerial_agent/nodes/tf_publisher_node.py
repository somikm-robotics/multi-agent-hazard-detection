# Placeholder for publishing drone pose as TF frames
# aerial_agent/nodes/tf_publisher_node.py
...
class TFPublisherNode(Node):
    def __init__(self):
        ...
        self.get_logger().info("✅ tf_publisher_node main() started")
    ...
    def broadcast_tf(self):
        ...
        t.transform.translation.z = 0.2  # Slight lift for visibility
